...
import { ChevronLeft, ChevronRight, Plus, Minus, TrendingUp } from "lucide-react";
...
const MONTHLY_ITEMS = POINTS_CONFIG_SEED.filter(
  item => item.workerType === WORKER_TYPE && (item.category === "B1" || item.category === "B2" || item.category === "C")
);
  ...
  return (
    <div className="flex flex-col min-h-full bg-background">
      ...
      <div className="sticky bottom-0 px-4 py-3 bg-white/95 backdrop-blur-md border-t border-border pb-safe shadow-elegant">
        <Button className="w-full h-12 text-base font-medium rounded-xl bg-blue-700 hover:bg-blue-800 shadow-elegant-md"
