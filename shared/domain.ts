...
export const POINTS_CONFIG_SEED: PointsConfigItem[] = [
  ...
  { itemId: 'GEN-C-01',  workerType: 'general', category: 'C',  name: '臨時交辦與績效', pointsPerUnit: 5000, unit: '月', frequency: '每月', note: '優5000/佳3000/平2000' },
  ...
  { itemId: 'OFF-C-01',  workerType: 'offshore', category: 'C',  name: '臨時交辦與績效', pointsPerUnit: 7200, unit: '月', frequency: '每月', note: '優7200/佳5200/平4200' },
  ...
  { itemId: 'SAF-C-01',  workerType: 'safety', category: 'C',  name: '臨時交辦與績效', pointsPerUnit: 5000, unit: '月', frequency: '每月', note: '優5000/佳3000/平2000' },
  ...
  { itemId: 'ENV-C-01',  workerType: 'environment', category: 'C',  name: '臨時交辦與績效', pointsPerUnit: 2000, unit: '月', frequency: '每月', note: '優2000/佳1000/平500' },
